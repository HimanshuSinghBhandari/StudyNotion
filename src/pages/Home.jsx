...
const Home = () => {
  return (
    <div>
       {/* section 1 */}
       <div className='relative mx-auto flex flex-col w-11/12 items-center max-w-maxContent text-white justify-between gap-8'>
        ...
        <div>
            ...
            heading={
                <div className='w-fit text-4xl font-semibold lg:w-[90%]'>
                    Unlock your
